    ...
    BEGIN {
        ...
        if($UseGroup -and $TargetDomains) {
            ...
            ForEach ($TargetDomain in $TargetDomains) {
                ...
                # only return results that have 'memberof' or 'primarygroupid' set
                ...
                $ObjectSearcher.FindAll() | ForEach-Object {
                    ...
                    if($AccountName -and (-not $AccountName.StartsWith('@'))) {
                        ...
                        # iterate through each membership for this object, if it exists
                        if($_.properties['memberof'] -and $_.properties['memberof'][0] -and ($_.properties['memberof'][0] -ne '')) {
