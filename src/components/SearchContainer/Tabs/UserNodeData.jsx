...
export default class UserNodeData extends Component {
    constructor() {
        ...
        this.state = {
            ...
            displayMap: { "displayname": "Display Name", "pwdlastset": "Password Last Changed", "lastlogon": "Last Logon", "enabled": "Enabled", "email": "Email", "title": "Title", "homedirectory": "Home Directory", "description": "Description", "userpassword": "User Password", "admincount": "AdminCount" }
        };
