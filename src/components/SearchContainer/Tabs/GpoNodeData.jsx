        ...
        return (
            <div className={this.props.visible ? "" : "displaynone"}>
                <dl className='dl-horizontal'>
                    ...
                    <NodeCypherLink property="Directly Affected OUs" target={this.state.label} baseQuery = {"MATCH p = (m:GPO {name:{name}})-[r:GpLink]->(n)"} start={this.state.label}/>

                    <NodeCypherLink property="Affected OUs" target={this.state.label} baseQuery = {"MATCH p = (m:GPO {name:{name}})-[r:GpLink|Contains*1..]->(n) WHERE n:OU OR n:Domain"} start={this.state.label}/>
