		...
		return (
			<Modal
				...
				<Modal.Header closeButton={true}>
					<Modal.Title id="WarnModalHeader">Clear Database</Modal.Title>
				</Modal.Header>
				...
				<Modal.Footer>
					<button onClick={this.closeAndOpenStep.bind(this)} type="button" className="btn btn-danger">Clear Database</button>
