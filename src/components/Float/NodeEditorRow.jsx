...
const NodeEditorRow = ({attributeName, val, deleteHandler, updateHandler}) => {
    ...
    const getValueColumn = () => {
        ...
        if (valType === 'boolean') {
            ...
            return (
                <div onInput={handleChangeString} suppressContentEditableWarning={true} className={styles.nodeEditString} contentEditable={editing}>
                    {internalValue}
                </div>
            );
        } else if (valType === 'number') {
            return (
                <div onInput={handleChangeNumber} suppressContentEditableWarning={true} className={styles.nodeEditNumber} contentEditable={editing}>
                    {internalValue}
                </div>
            );
